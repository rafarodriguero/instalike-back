...
class Configuration {
    constructor(givenConfig, logger) {
        ...
        this._givenConfiguration =
            (givenConfig === null || givenConfig === void 0 ? void 0 : givenConfig.toString()) === '[object Object]' ? givenConfig : {};
    ...
    _checkLocalServiceContext() {
        ...
        if (((_a = this._givenConfiguration.serviceContext) === null || _a === void 0 ? void 0 : _a.toString()) === '[object Object]') {
            ...
            else if (((_b = this._givenConfiguration.serviceContext) === null || _b === void 0 ? void 0 : _b.service) !== undefined) {
            ...
            else if (((_c = this._givenConfiguration.serviceContext) === null || _c === void 0 ? void 0 : _c.version) !== undefined) {
    ...
    _gatherLocalConfiguration() {
        ...
        if (((_a = this._givenConfiguration) === null || _a === void 0 ? void 0 : _a.reportMode) !== undefined) {
        ...
        const hasEnvCheck = ((_b = this._givenConfiguration) === null || _b === void 0 ? void 0 : _b.ignoreEnvironmentCheck) !== undefined;
        const hasReportMode = ((_c = this._givenConfiguration) === null || _c === void 0 ? void 0 : _c.reportMode) !== undefined;
        if (hasEnvCheck) {
        ...
        if (hasEnvCheck && hasReportMode) {
            ...
            else if (((_d = this._givenConfiguration) === null || _d === void 0 ? void 0 : _d.ignoreEnvironmentCheck) !== undefined &&
        ...
        else if (((_e = this._givenConfiguration) === null || _e === void 0 ? void 0 : _e.key) !== undefined) {
        ...
        else if (((_f = this._givenConfiguration) === null || _f === void 0 ? void 0 : _f.keyFilename) !== undefined) {
            throw new Error('config.keyFilename must be a string');
        }
        if (((_g = this._givenConfiguration.credentials) === null || _g === void 0 ? void 0 : _g.toString()) === '[object Object]') {
            this.credentials = this._givenConfiguration.credentials;
        }
        else if (((_h = this._givenConfiguration) === null || _h === void 0 ? void 0 : _h.credentials) !== undefined) {
        ...
        else if (((_j = this._givenConfiguration) === null || _j === void 0 ? void 0 : _j.reportUnhandledRejections) !== undefined) {
    ...
    _checkLocalProjectId() {
        ...
        if (((_a = this._givenConfiguration) === null || _a === void 0 ? void 0 : _a.projectId) !== undefined) {
