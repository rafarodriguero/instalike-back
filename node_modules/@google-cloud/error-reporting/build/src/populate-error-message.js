...
exports.populateErrorMessage = void 0;
...
function populateErrorMessage(ob, em) {
    ...
    else if (typeof ob === 'object' && (ob === null || ob === void 0 ? void 0 : ob.toString()) === '[object Object]') {
...
function populateFromError(err, errorMessage) {
    ...
    if ((err === null || err === void 0 ? void 0 : err.user) !== undefined) {
        errorMessage.setUser(err.user);
    }
    if ((err === null || err === void 0 ? void 0 : err.serviceContext) !== undefined &&
        ((_a = err.serviceContext) === null || _a === void 0 ? void 0 : _a.toString()) === '[object Object]') {
...
function populateFromObject(ob, errorMessage) {
    var _a;
    if ((ob === null || ob === void 0 ? void 0 : ob.message) !== undefined) {
        errorMessage.setMessage(ob.message);
    }
    else {
        errorMessage.setMessage((0, build_stack_trace_1.buildStackTrace)(util.inspect(ob)));
    }
    if ((ob === null || ob === void 0 ? void 0 : ob.user) !== undefined) {
        errorMessage.setUser(ob.user);
    }
    if ((ob === null || ob === void 0 ? void 0 : ob.filePath) !== undefined) {
        errorMessage.setFilePath(ob.filePath);
    }
    if ((ob === null || ob === void 0 ? void 0 : ob.lineNumber) !== undefined) {
        errorMessage.setLineNumber(ob.lineNumber);
    }
    if ((ob === null || ob === void 0 ? void 0 : ob.functionName) !== undefined) {
        errorMessage.setFunctionName(ob.functionName);
    }
    if ((ob === null || ob === void 0 ? void 0 : ob.serviceContext) !== undefined &&
        ((_a = ob.serviceContext) === null || _a === void 0 ? void 0 : _a.toString()) === '[object Object]') {
