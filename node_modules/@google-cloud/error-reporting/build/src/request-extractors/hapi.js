...
exports.hapiRequestInformationExtractor = void 0;
...
function attemptToExtractStatusCode(req) {
    ...
    if (typeof req.response === 'object') {
        ...
        else if (((_a = req.response.output) === null || _a === void 0 ? void 0 : _a.toString()) === '[object Object]') {
...
function extractRemoteAddressFromRequest(req) {
    ...
    else if (((_a = req.info) === null || _a === void 0 ? void 0 : _a.toString()) === '[object Object]') {
...
function hapiRequestInformationExtractor(req) {
    ...
    if ((req === null || req === void 0 ? void 0 : req.toString()) !== '[object Object]' ||
        ((_a = req.headers) === null || _a === void 0 ? void 0 : _a.toString()) !== '[object Object]' ||
        typeof req === 'function' ||
        Array.isArray(req)) {
        return returnObject;
    }
