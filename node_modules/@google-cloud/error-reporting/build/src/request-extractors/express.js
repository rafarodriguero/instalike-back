...
exports.expressRequestInformationExtractor = void 0;
...
function extractRemoteAddressFromRequest(req) {
    ...
    else if (((_a = req.connection) === null || _a === void 0 ? void 0 : _a.toString()) === '[object Object]') {
...
function expressRequestInformationExtractor(req, res) {
    ...
    if ((req === null || req === void 0 ? void 0 : req.toString()) !== '[object Object]' ||
        ...
        (res === null || res === void 0 ? void 0 : res.toString()) !== '[object Object]') {
        return returnObject;
    }
    returnObject
